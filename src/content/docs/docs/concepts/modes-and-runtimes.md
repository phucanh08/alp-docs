...
Tài liệu này phản ánh checkout `alp-code` tại commit `777113b` sau tag `v0.10.4`. Model mapping có thể đổi ở release sau; `alp --help` trên máy luôn phản ánh bản đang cài.
...
Tier 2 chuẩn bị execution thật nhưng dừng trước spawn; output cho biết model, runtime, quyền và launch spec mà mode sẽ tạo.
